    ...
    <div className="min-h-screen p-8 max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="mb-8">
        <div className="flex gap-2">
          <input
            ...
            placeholder="Enter cache tag (e.g., v0-header, v1-product-5)"
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <QuickButton tag="v0-product-5" setTag={setTag} />
          <QuickButton tag="v0-product-10" setTag={setTag} />
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <QuickButton tag="v1-product-5" setTag={setTag} />
          <QuickButton tag="v1-product-10" setTag={setTag} />
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <QuickButton tag="v2-product-5" setTag={setTag} />
          <QuickButton tag="v2-product-10" setTag={setTag} />
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <QuickButton tag="v3-product-5" setTag={setTag} />
          <QuickButton tag="v3-product-10" setTag={setTag} />
        </div>
      </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 mt-1">
              ...
              <li><code className="bg-zinc-100 dark:bg-zinc-800 px-1 rounded">v0-product-[1-10]</code></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 mt-1">
              ...
              <li><code className="bg-zinc-100 dark:bg-zinc-800 px-1 rounded">v1-product-[1-10]</code></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 mt-1">
              ...
              <li><code className="bg-zinc-100 dark:bg-zinc-800 px-1 rounded">v2-product-[1-10]</code></li>
            </ul>
          </div>
          <div>
            <p className="font-medium text-zinc-700 dark:text-zinc-300">v3: Header in root layout (local cache)</p>
            <ul className="list-disc list-inside space-y-1 mt-1">
              <li><code className="bg-zinc-100 dark:bg-zinc-800 px-1 rounded">v3-header</code></li>
              <li><code className="bg-zinc-100 dark:bg-zinc-800 px-1 rounded">v3-product-[1-10]</code></li>
            </ul>
          </div>
        </div>
      </div>
